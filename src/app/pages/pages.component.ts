...
export class PagesComponent implements OnInit {
  ...
  expandNavigation(): void {
    ...
    jQuery('app-pages').removeClass('nav-collapsed');
  ...
  collapseNavigation(): void {
    ...
    jQuery('app-pages').addClass('nav-collapsed');
    // this.$sidebar.find('.collapse.in').collapse('hide') // Para useHash true
    this.$sidebar.find('.collapse').collapse('hide') // Para useHash false
  ...
  toggleNavigationCollapseState(): void {
    if (jQuery('app-pages').is('.nav-collapsed')) {
  ...
  enableSwipeCollapsing(): void {
    ...
    swipe.on('swiperight', () => {
      ...
      if (jQuery('app-pages').is('.chat-sidebar-opened')) { return; }
